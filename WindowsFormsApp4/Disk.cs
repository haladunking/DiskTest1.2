...
namespace DiskTest11
{
    ...
    public partial class Disk : Sunny.UI.UIPage
    {
        ...
        public Disk()
        {
            ...
            //设定字体大小为12px      
            //DiskSetting form = (DiskSetting)this.Owner;
            //if (this.returnTestOrNot())
            //{
            //    form.nc_format_info.Add(this.returnTestOrNot());
            //    form.nc_format_info.Add(this.returnTestMode());
            //    form.nc_format_info.Add(this.returnTestDataMode());
            //    form.nc_format_info.Add(this.returnTestPercent());
            //    form.nc_format_info.Add(this.returnBlockSize());
            //    form.nc_format_info.Add(this.returnTestTime());
            //    form.nc_format_info.Add(this.returnTestCircle());
            //    form.nc_format_info.Add(this.returnTestNum());
            //}
